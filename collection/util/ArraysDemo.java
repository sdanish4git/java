...
public class ArraysDemo {
	...
	private static void sequential() {
		...
		//strings.set(0,)
		strings.set(0, "john");
		System.out.println("Updated Array:1 " + strings);
		System.out.println("Updated Array: 2" + Arrays.toString(strArray));
		
		// Creating modifiable ArrayList from an Array
		strings = new ArrayList(Arrays.asList(strArray));
		strings.add("a");	
		System.out.println("Updated Array:3 " + strings);
		System.out.println("Updated Array:4 " + Arrays.toString(strArray));
		// Showing varargs
